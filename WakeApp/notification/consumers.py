...
# from WakeApp.chat.models import UnreadChatRoomMessages
from twisted.protocols.memcache import ClientError

from WakeApp.friend.models import FriendRequest, FriendList

# from chat.exceptions import ClientError
from WakeApp.notification.constants import CHAT_MSG_TYPE_GET_UNREAD_NOTIFICATIONS_COUNT, \
	CHAT_MSG_TYPE_PAGINATION_EXHAUSTED, CHAT_MSG_TYPE_GET_NEW_NOTIFICATIONS, CHAT_MSG_TYPE_NOTIFICATIONS_PAYLOAD, \
	GENERAL_MSG_TYPE_GET_UNREAD_NOTIFICATIONS_COUNT, GENERAL_MSG_TYPE_GET_NEW_GENERAL_NOTIFICATIONS, \
	GENERAL_MSG_TYPE_NOTIFICATIONS_REFRESH_PAYLOAD, GENERAL_MSG_TYPE_PAGINATION_EXHAUSTED, \
	GENERAL_MSG_TYPE_UPDATED_NOTIFICATION, GENERAL_MSG_TYPE_NOTIFICATIONS_PAYLOAD
from WakeApp.notification.models import Notification
